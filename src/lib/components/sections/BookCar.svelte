<script>
  ...
  const locations = {
    levelOne: ['Belgrade', 'Novi Sad', 'Nis', 'Kragujevac', 'Subotica']
  };
  const dropLocation = {
...
<style lang="postcss">
  .container {
    @apply my-0 mx-auto max-w-[1200px] py-0 px-4;
  }
  .book-content {
    @apply mt-0 mb-20 mx-auto;
  }
  .book-content__box {
    @apply bg-[url('$lib/images/book-bg.png')] bg-[50%] bg-no-repeat bg-cover flex flex-col h-auto py-8 p-12 w-full z-[4] shadow-4xl;
  }
  .box-form {
